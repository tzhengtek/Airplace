      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-4 overflow-y-auto">
        <DialogPanel className="w-full max-w-md rounded-md bg-white p-10 text-black">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button className="cursor-pointer justify-center text-zinc-200 flex gap-2 hover:shadow-xl/10 items-center bg-[#5865F2] px-4 py-2 rounded-lg font-medium text-sm hover:bg-[#3b4aed] transition-all ease-in duration-200">
              <svg
                className="w-6"
